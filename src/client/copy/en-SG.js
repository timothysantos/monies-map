export const messages = {
  ...
  entries: {
    ...
    searchPlaceholder: "Merchant, note, wallet, amount...",
    filter: "Filter",
    filtered: "Filtered",
  ...
  imports: {
    ...
    inboxFileOwner: (ownerLabel) => `Owner: ${ownerLabel}`,
  ...
  settings: {
    ...
    shortcutInstallDetail: "The Apple-signed shortcut saves Wallet amount, merchant, date, and card context, confirms the account used, and opens the entry for optional edits.",
    ...
    shortcutInstallStep: "Install the Apple-signed shortcut from Monies Map.",
    ...
    shortcutApiParamsList: "date, description or merchant, amount or amountMinor, currency, name, accountId or accountName, categoryName, entryType, transferDirection, ownershipType, ownerName, offsetsCategory, note, requestId, clientVersion, view.",
