export const messages = {
  ...
  settings: {
    ...
    trustRulesDetail: "Use opening balances for your start point, statement checkpoints for monthly proof, and watch unresolved transfers or stale imports before trusting a wallet total.",
