export const messages = {
  ...
  settings: {
    ...
    shortcutInstallDetail: "The verified shortcut sends Wallet transaction amount, merchant, and date directly to Monies Map.",
    ...
    shortcutPasteStep: "Paste the copied connection when Apple asks.",
    shortcutAutomationStep: "In Shortcuts, add a Transaction automation that runs Monies Map Apple Pay Direct.",
