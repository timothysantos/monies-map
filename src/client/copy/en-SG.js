export const messages = {
  ...
  settings: {
    ...
    shortcutDefaultParamsPlaceholder: "category=Other&owner=Tim&shared=false",
    ...
    shortcutUrlParamsList: "action=add-expense, amount, merchant or description, date, account or account_id, category, owner, shared, note.",
    shortcutApiParamsTitle: "Direct-create API JSON",
    shortcutApiParamsList: "date, description, amount or amountMinor, accountId or accountName, categoryName, entryType, transferDirection, ownershipType, ownerName, offsetsCategory, note, splitBasisPoints, view.",
