export const messages = {
  ...
  imports: {
    ...
    composerDetail: "Paste or upload a CSV, or upload a supported PDF statement, then review one import batch before it reaches the ledger.",
    stepsLabel: "Import steps",
    steps: ["Select file", "Data mapping", "Review"],
    selectFileTitle: "Select file",
    selectFileDetail: "Choose one CSV or supported PDF statement and set the defaults that should apply before row-level review.",
    selectFileNextPaste: "After pasting CSV rows, review the mapping step below.",
    selectFileNextUpload: "PDF statements are converted into reviewable rows. Pasting CSV works directly in the text box.",
    ...
    csvPlaceholder: "Paste CSV rows here, or upload a CSV/PDF below.",
    uploadFile: "Upload CSV or PDF",
    dropzoneTitle: "Drop a CSV or PDF here",
    dropzoneDetail: "Click to browse, or drag a supported UOB statement onto this area.",
    ...
    uploadParsing: (fileName) => `Parsing statement rows from ${fileName}.`,
