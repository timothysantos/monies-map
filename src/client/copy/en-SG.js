export const messages = {
  ...
  imports: {
    ...
    composerDetail: "Paste or upload a CSV, upload a supported PDF statement, upload a local OCR statement package, or upload a supported current-transaction XLS. PDF and OCR statement packages certify the period like a bank sync; mid-cycle files keep the working ledger current.",
    stepsLabel: "Import steps",
    steps: ["Select file", "Data mapping", "Review"],
    selectFileTitle: "Select file",
    selectFileDetail: "Choose one CSV, supported PDF statement, local OCR statement package, or supported current-transaction XLS and set the defaults that should apply before row-level review.",
    selectFileNextPaste: "After pasting CSV rows, review the mapping step below.",
    selectFileNextUpload: "PDF statements, local OCR statement packages, and supported current-transaction XLS files are converted into reviewable rows. Pasting CSV works directly in the text box.",
    ...
    csvPlaceholder: "Paste CSV rows here, or upload a CSV/PDF/OCR/XLS below.",
    uploadFile: "Upload CSV, PDF, OCR, or XLS",
    dropzoneTitle: "Drop a CSV, PDF, OCR, or XLS here",
