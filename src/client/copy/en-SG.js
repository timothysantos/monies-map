export const messages = {
  ...
  settings: {
    ...
    categoryRulesDetail: "Rules help categorize new import rows that are still uncategorized or Other. Capitalization, spaces, and punctuation do not matter. Specific merchant names can match any part of the bank text, very short names only match as their own word, and lower priority numbers are checked first.",
    ...
    categoryRuleDialogDetail: "Match merchant text from bank rows to a category before review. Rules only apply automatically when a row is uncategorized or still Other.",
